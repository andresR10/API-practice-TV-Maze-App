...
async function getEpisodesOfShow(id) { 
  const episodes = await axios.get(` https://api.tvmaze.com/shows/${id}/episodes?specials=1`)

  return episodes.data.map(episode => ({id: episode.id, name: episode.name, season: episode.season, number: episode.number}))
}
